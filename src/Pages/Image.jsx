    ...
    return (
        <div className="flex flex-col gap-8 p-5">
            ...
            { data && 
                ...
                <div className="bg-[#11182722] rounded-lg backdrop-blur-md flex flex-col xl:flex-row gap-5 p-8">
                    <img src={data.urls.full} className="rounded-lg h-[40rem] w-full object-cover flex-1"/>
                    <div className="">
                        <h1 className="text-white font-medium w-full"><b>Clicked by:</b> {data.user.name}</h1>
                        <h1 className="text-white font-medium w-full"><b>Description:</b> {data.description}</h1>
                        <h1 className="text-white font-medium w-full">
                            <a href={data.links.html} className="flex hover:text-gray-500 font-bold">
                                <h1>Link to photo</h1>
